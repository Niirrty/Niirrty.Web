...
final class Domain
{
    ...
    *
    * @var \Niirrty\Web\SecondLevelDomain
    */
   private $_sld;
    ...
    *
    * @return \Niirrty\Web\SecondLevelDomain|null
    */
   ...
   public function isFullyQualified() : bool
   {
      ...
      if ( null === $this->_sld ) { return false; }
   ...
   /**
    * Is the SLD pointing to known public URL shortener service? They are used to shorten or hide some long or bad URLs.
    *
    * @return bool
    */
    ...
    * @param  \Niirrty\Web\Domain $parsedDomainOut    Returns the Domain if the method returns true
      ...
      ?string $domainString, &$parsedDomainOut, bool $allowOnlyKnownTlds = false, bool $convertUniCode = true ) : bool
   {
      ...
      if ( $convertUniCode ) { $domainString = idnToASCII( $domainString ); }
    ...
    * @param  boolean             $allowOnlyKnownTlds Are only known main TLDs allowed to be a parsed as a TLD?
    * @param  bool                $convertUniCode     Convert unicode Domain to Puny code? (Default = TRUE)
    * @return \Niirrty\Web\Domain|false
    */
   public static function Parse( ?string $domainString, bool $allowOnlyKnownTlds = false, bool $convertUniCode = true )
   {
      ...
      $parsedDomainOut = new Domain( $_domainString, $sld );
